  ...
  return (
    <div className="container">
      <div className="row p-5 mb-5">
        <h1 className="fs-2 text-center mt-5 text-muted">
          We pioneered the discount broking model in India.
          <br />
          Now, we are breaking ground with our technology.
        </h1>
      </div>
      <div className="row border-top mx-5 " style={{marginTop:"60px",padding:"90px"}}>
        <div className="col-6 mx-5" style={{width:"450px"}}>
          <p>
